...
class ArmIk:
    ...
    def __init__(
        self,
        model_file="/home/luocl/Desktop/my_project/kuavo-ros-opensource/src/kuavo_assets/models/biped_s49/urdf/biped_s49.urdf",
        box_file="./models/box/box_panels.urdf",
        end_frames_name= ["dummy_link", "zarm_l7_joint_parent", "zarm_r7_joint_parent"],
        constraint_tol=9e-3,
        solver_tol=1.0e-3,
        ori_cost_weight=10,
        ori_vector_tol=30,
    ...
    #     # 打印从基座到末端的变换链
    #     frame_names = ["base_link", "zarm_l1_link", "zarm_l2_link", "zarm_l3_link", 
    ...
    def right_hand_pose(self, q):
        ...
        # 打印从基座到末端的变换链
        frame_names = ["base_link", "zarm_r1_link", "zarm_r2_link", "zarm_r3_link", 
...
if __name__ == "__main__":
    ...
    # 定义目标位置
    l_hand_pose = np.array([-0.01749985, 0.2627, -0.4537])  # [x, y, z] 单位m
    r_hand_pose = np.array([-0.01729985 ,-0.2627 ,-0.4537])
